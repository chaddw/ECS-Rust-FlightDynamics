//Calculates all of the forces and moments on the plane at any time (called inside eom)
...
use crate::bourg_fdm::functions::airfoil_coef::rudder_drag_coefficient;
use crate::bourg_fdm::functions::airfoil_coef::rudder_lift_coefficient;
use crate::bourg_fdm::functions::airfoil_coef::drag_coefficient;
use crate::bourg_fdm::functions::airfoil_coef::lift_coefficient;
